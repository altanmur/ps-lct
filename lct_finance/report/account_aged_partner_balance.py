...
# Monkeys
aged_trial_report._get_lines = _get_lines
aged_trial_report._get_lines_with_out_partner = _get_lines_with_out_partner

report_sxw.report_sxw('report.aged_trial_balance',
                      'account.account',
                      'lct_finance/report/account_aged_trial_balance.rml',
